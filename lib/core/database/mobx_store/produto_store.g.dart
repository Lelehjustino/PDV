...
mixin _$ProdutoStore on _ProdutoStore, Store {
  ...
  bool get dadosPreenchidos => (_$dadosPreenchidosComputed ??= Computed<bool>(
          ...
          name: '_ProdutoStore.dadosPreenchidos'))
      .value;
  ...
  @override
  dynamic atualizarDescricao({required String descricao}) {
    final _$actionInfo = _$_ProdutoStoreActionController.startAction(
        name: '_ProdutoStore.atualizarDescricao');
    try {
      return super.atualizarDescricao(descricao: descricao);
    } finally {
      _$_ProdutoStoreActionController.endAction(_$actionInfo);
    }
  }
  ...
  @override
  dynamic atualizarValor({required String valor}) {
    final _$actionInfo = _$_ProdutoStoreActionController.startAction(
        name: '_ProdutoStore.atualizarValor');
    try {
      return super.atualizarValor(valor: valor);
    } finally {
      _$_ProdutoStoreActionController.endAction(_$actionInfo);
    }
  }
